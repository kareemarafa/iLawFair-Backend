    ...
    stages {
        stage("Deploy web-builder to Development") {
            ...
            steps {
                ...
                sh 'ssh -o stricthostkeychecking=no deploy@website-me.com "cd /var/www/dev.api.user.website-me.com/ && nx build web-builder && NODE_ENV=dev nx build api-builder && pm2 restart dev_API_builder"' // build
            }
        }
    }
}
